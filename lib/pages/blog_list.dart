...
List<Map<String, String>> blogs = [
  {
    ...
    'imageURL': 'lib/assets/images/viewport.jpg',
    'url':
  ...
  },
  {
    ...
    'imageURL': 'lib/assets/images/codereview.jpg',
    'url':
        'https://medium.com/@koushikrad/code-reviews-best-practices-686a365b79a8',
    'description':
        'There are numerous good articles, books available on the internet for the best code review practices such as Proven effective practices of code review, Humanizing Peer Reviews etc., In this post am gonna articulate my own experience on the best code review practices and also share what I have learnt from reading through various blogs and books on the same.'
  },
  {
    'title':
        'Exploring Flutter for Business Apps: Weighing Advantages and Drawbacks',
    'imageURL': 'lib/assets/images/why_flutter.png',
    'url':
        'https://medium.com/@koushikrad/exploring-flutter-for-business-apps-weighing-advantages-and-drawbacks-ba530e5a61e2',
    'description':
        'After spending the past five months immersed in Flutter development, tackling both official projects and personal applications, I’m excited to bring my insights to the table. In this blog, I’ll be shedding light on why choosing Flutter for business development could be a game-changer. But don’t worry, I won’t be diving into the nitty-gritty technical details just yet — this post is all about the business perspective. If you’re eager to delve into the technical side of choosing Flutter, stay tuned for my next post. Keep an eye on this space!'
  }
].toList();
